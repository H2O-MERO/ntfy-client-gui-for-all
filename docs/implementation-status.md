...
| FemtoVG build option | Source/configured; CI check | CI check | CI check |
...
| Durable gap recovery with ntfy `since` | Not implemented | Not implemented | Not implemented |
...
| Explicit current-user pipe DACL | Pending | N/A | N/A |
